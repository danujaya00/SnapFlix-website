...
var messenger1 = function(el){
  ...
  m.init = function(){
    ...
    m.fadeBuffer = false;
    m.messages = [
      'Sri lankas First-Ever Short film Hackathon, that creates a platform to guide and encourage SriLankan youth to participate in international competitions and make our country shine on a global stage.',
    ];
